      ...
      <main className="overflow-x-hidden bg-white text-[#2C2C2C]">
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-12">
          <div className="max-w-7xl mx-auto prose prose-neutral prose-lg max-w-none">
            <p>
              Welcome, I’m <strong>Russell Nobles</strong>, owner of <strong>RN Construction</strong>. Our commercial team
              coordinates with owners and tenants so offices and retail spaces open on time. We plan around operations and
