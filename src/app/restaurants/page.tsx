      ...
      <main className="overflow-x-hidden bg-white text-[#2C2C2C]">
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-12">
          <div className="max-w-7xl mx-auto prose prose-neutral prose-lg max-w-none">
            <p>
              I’m <strong>Russell Nobles</strong>. Restaurants move fast, so we coordinate with your design team and
              equipment vendors to keep approvals and installation aligned. Our goal is a smooth opening day.
            </p>
