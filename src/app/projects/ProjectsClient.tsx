...
// /* ───────────────────────── ModalImage (with skeleton + fallback) ───────────────────────── */
...
// // when opening the lightbox, pass both optimized and originals for fallback
// const openLightbox = (images: string[], startIndex = 0) =>
//   setLightbox({
//     images: images.map((s) => toOptimized(s, 1600, 'webp')),
//     fallbacks: images, // originals as fallback
//     index: startIndex,
//   });
...
//             <ModalImage src={lightbox.images[lightbox.index]} alt="Project image large view" />
//           ) : null}
...
// Integrates shared LightboxCarousel (+ optional HorizontalCarousel if desired)
// =============================
'use client';
...
// If you want an inline scroller under sections, import and use:
...
export default function ProjectsClient() {
  ...
  const openLightbox = (images: string[], startIndex = 0) => setViewer({ images, index: startIndex });
