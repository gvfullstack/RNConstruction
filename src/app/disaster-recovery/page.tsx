      ...
      <main className="overflow-x-hidden bg-white text-[#2C2C2C]">
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-12">
          <div className="max-w-7xl mx-auto prose prose-neutral prose-lg max-w-none">
            <p>
              Welcome, I’m <strong>Russell Nobles</strong>, owner of <strong>RN Construction</strong>. When disaster strikes,
              we step in early to stabilize the site, document the damage, and guide you through each decision. We coordinate
              with adjusters and keep you informed as we rebuild.
            </p>
