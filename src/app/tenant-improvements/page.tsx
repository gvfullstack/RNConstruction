      ...
      <main className="overflow-x-hidden bg-white text-[#2C2C2C]">
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-12">
          <div className="max-w-7xl mx-auto prose prose-neutral prose-lg max-w-none">
            <p>
              Welcome, I’m <strong>Russell Nobles</strong>, owner of <strong>RN Construction</strong>. We build tenant spaces
              with respect for neighbors and building rules. Our team coordinates with property managers and keeps dust and
              noise under control.
            </p>
