...
export default function Home() {
  ...
  const openLightbox = (images: string[], index = 0) => setViewer({ images, index });
  const closeLightbox = () => setViewer(null);
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white text-[#2C2C2C] font-sans overflow-x-hidden">
        ...
        <section aria-labelledby="welcome" className="px-4 sm:px-6 lg:px-8 py-10 bg-white">
          ...
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-gray-800 text-lg leading-relaxed">
              ...
              <span className="font-semibold"> RN Construction</span>. My team helps families and businesses plan, permit, and build with clear
              communication and craftsmanship. We handle residential work like kitchens, baths, additions, and complete rebuilds, and we also
              deliver award-winning commercial projects including restaurants, tenant improvements, public works, and multi-family repairs. From
              early budgeting and scheduling to permits, inspections, and punch lists, you get one accountable partner who keeps things moving and
              keeps you informed.
            </p>
            <p className="text-gray-800 text-lg leading-relaxed mt-4">
              If you are exploring a project or rebuilding after a loss, I would be glad to talk through your options and outline a practical path
              forward. <span className="font-semibold">Reach out anytime</span> to schedule a consultation or give us a call. We are here to help.
            </p>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid lg:grid-cols-2 gap-10">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-6">We deliver residential and commercial projects with the same focus on clarity, schedule, and craftsmanship.</p>
                <ul className="divide-y divide-gray-200 rounded-xl border border-gray-200 bg-white">
                  {[
                    ...
                    <li key={label}>
                      <Link href={href} className="flex items-start justify-between gap-4 p-4 hover:bg-gray-50 transition">
                        <div>
              ...
              <div>
                ...
                <p className="text-gray-600 mb-6">One accountable team from concept to keys. Explore our delivery methods and specialties.</p>
                <ul className="divide-y divide-gray-200 rounded-xl border border-gray-200 bg-white">
                  {[
                    ...
                    <li key={id}>
                      <Link href={`/capabilities#${id}`} className="flex items-start justify-between gap-4 p-4 hover:bg-gray-50 transition">
                        <div>
                          <div className="font-semibold">{label}</div>
                          <div className="text-sm text-gray-600">{sub}</div>
                        </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-stretch">
              ...
              <article className="rounded-xl overflow-hidden border border-gray-200 bg-white">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mt-2">
                    A ground-up rebuild coordinated with engineers, adjusters, and inspectors—delivered on schedule with
              ...
              <article className="rounded-xl overflow-hidden border border-gray-200 bg-white">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mt-2">
                    Integrated hardscape, water features, and planting—planned with drainage and grading in mind so beauty
                    meets durability.
                  </p>
                  <div className="mt-4">
                    <button
        ...
        {/* SELECTED WORK (collage -> click to view) */}
        ...
        {/* Example reusable carousel (optional usage) */}
        <section className="px-4 sm:px-6 lg:px-8 py-16 bg-white border-t border-gray-100">
          <div className="mx-auto max-w-7xl">
            <h2 className="text-xl font-semibold text-[#B21F24] mb-4">More Photos</h2>
            <HorizontalCarousel
              items={projectCategories[0].projects[0].images.map((src, i) => ({
                src,
                alt: `Napa image ${i + 1}`,
                onClick: () => openLightbox(projectCategories[0].projects[0].images, i),
              }))}
            />
          </div>
        </section>
